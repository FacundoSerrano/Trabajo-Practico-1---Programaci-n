...
void* al_get(ArrayList* this, int index)
{
    ...
    if(this != NULL)
    {
        if(index >= 0 && index < this->len(this)) //this->size)
        {
...
int al_clear(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        ...
        this->reservedSize = AL_INITIAL_VALUE;
        free(this->pElements);
        (void**) realloc(this->pElements,sizeof(void*) * this->reservedSize);
        returnAux = 0;
    }
...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        ...
        {
            newArray->add(newArray, this->get(this, i));
        }
        returnAux = newArray;
    }
...
/** \brief Decrements the number of elements in pList in AL_DECREMENT elements.
 * \param pList ArrayList* Pointer to arrayList
 * \return int Return (-1) if Error [pList is NULL pointer]
 *                  - (0) if ok
 */
int resizeDown(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        ...
        if(this->reservedSize > (len + AL_INCREMENT))
        {
...
int expand(ArrayList* this,int index)
{
    ...
    if(this != NULL)
    {
        ...
        {
            this->set(this, i+1, this->pElements+i);
        }
        returnAux = 0;
    }
